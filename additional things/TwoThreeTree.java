...
public class TwoThreeTree<E extends Comparable<E>> {
  ...
  */
  ...
  private void raiseSurplus(TwoThreeNode x) {
  	...
  	if ((x.parent != null) && (x.numberChildren == 4)) {
		...
		if (p.numberChildren == 2) {
			if (x.fourthMax().compareTo(p.firstMax) <= 0) { // if x is first child
				p.thirdMax = p.secondMax();
				p.secondMax = node2.secondMax();
				p.firstMax = node1.secondMax();
				...
				p.thirdMax = node2.secondMax();
                                p.secondMax = node1.secondMax();
		...
		else {  // number of children of parent of x is three
			if (x.fourthMax().compareTo(p.firstMax()) <= 0) {   // if x is a first child
				p.fourthMax = p.thirdMax();
				p.thirdMax = p.secondMax();
                                p.secondMax = node2.secondMax();
                                p.firstMax = node1.secondMax();
				
				p.fourthChild = p.thirdChild();
                                p.thirdChild = p.secondChild();
                                p.secondChild = node2;
                                p.firstChild = node1;
			}	

			else if (x.fourthMax().compareTo(p.secondMax()) <= 0) {  // if x is a second child
				p.fourthMax = p.thirdMax(); 
                                p.thirdMax = node2.secondMax();
                                p.secondMax = node1.secondMax();
                                // firstMax is same
			...
			else {    // x is a third child
				p.fourthMax = node2.secondMax();
                                p.thirdMax = node1.secondMax();
